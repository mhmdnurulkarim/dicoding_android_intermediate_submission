...
import com.example.mystoryapps.DataDummy
import com.example.mystoryapps.MainDispatcherRule
import com.example.mystoryapps.adapter.ListStoryAdapter
import com.example.mystoryapps.data.StoryRepository
import com.example.mystoryapps.getOrAwaitValue
...
class ListStoryViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        ...
        val actualStory: PagingData<Story> = listViewModel.story.getOrAwaitValue()
